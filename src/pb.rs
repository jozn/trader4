...
pub struct ProtoHeartbeatEvent {
    #[prost(enumeration="ProtoPayloadType", optional, tag="1", default="HeartbeatEvent")]
    pub payload_type: ::core::option::Option<i32>,
}
///* Asset entity. 
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct Symbol {
    ...
    #[prost(enumeration="CommissionType", optional, tag="15", default="UsdPerMillionUsd")]
    ...
    #[prost(enumeration="SymbolDistanceType", optional, tag="20", default="SymbolDistanceInPoints")]
    ...
    #[prost(enumeration="MinCommissionType", optional, tag="22", default="Currency")]
    ...
    #[prost(enumeration="SwapCalculationType", optional, tag="29", default="Pips")]
...
pub struct Trader {
    ...
    #[prost(enumeration="AccessRights", optional, tag="7", default="FullAccess")]
    ...
    #[prost(enumeration="LimitedRiskMarginCalculationStrategy", optional, tag="19", default="AccordingToLeverage")]
...
pub struct Position {
    ...
    #[prost(enumeration="OrderTriggerMethod", optional, tag="14", default="Trade")]
...
pub struct Order {
    ...
    #[prost(enumeration="TimeInForce", optional, tag="18", default="ImmediateOrCancel")]
    ...
    #[prost(enumeration="OrderTriggerMethod", optional, tag="24", default="Trade")]
...
pub struct ApplicationAuthReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaApplicationAuthReq")]
    pub payload_type: ::core::option::Option<i32>,
...
pub struct ApplicationAuthRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaApplicationAuthRes")]
    pub payload_type: ::core::option::Option<i32>,
}
...
pub struct AccountAuthReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaAccountAuthReq")]
    pub payload_type: ::core::option::Option<i32>,
...
pub struct AccountAuthRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaAccountAuthRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// The unique identifier of the trader's account in cTrader platform.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ErrorRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaErrorRes")]
    pub payload_type: ::core::option::Option<i32>,
    ///The unique identifier of the trader's account in cTrader platform.
...
pub struct ClientDisconnectEvent {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaClientDisconnectEvent")]
    pub payload_type: ::core::option::Option<i32>,
...
pub struct AccountsTokenInvalidatedEvent {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaAccountsTokenInvalidatedEvent")]
    pub payload_type: ::core::option::Option<i32>,
    /// The unique identifier of the trader's account in cTrader platform.
...
pub struct VersionReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaVersionReq")]
    pub payload_type: ::core::option::Option<i32>,
}
///* Response to the VersionReq request. 
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct VersionRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaVersionRes")]
    pub payload_type: ::core::option::Option<i32>,
...
pub struct NewOrderReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaNewOrderReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// The unique identifier of the trader's account in cTrader platform.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
    ...
    #[prost(enumeration="TimeInForce", optional, tag="9", default="GoodTillCancel")]
    pub time_in_force: ::core::option::Option<i32>,
    ...
    #[prost(enumeration="OrderTriggerMethod", optional, tag="23", default="Trade")]
    pub stop_trigger_method: ::core::option::Option<i32>,
}
...
pub struct ExecutionEvent {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaExecutionEvent")]
    pub payload_type: ::core::option::Option<i32>,
...
pub struct CancelOrderReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaCancelOrderReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct AmendOrderReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaAmendOrderReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
    ...
    pub trailing_stop_loss: ::core::option::Option<bool>,
    /// Trigger method for the STOP or the STOP_LIMIT pending order.
    #[prost(enumeration="OrderTriggerMethod", optional, tag="15", default="Trade")]
    pub stop_trigger_method: ::core::option::Option<i32>,
}
...
pub struct AmendPositionSltpReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaAmendPositionSltpReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
    ...
    #[prost(enumeration="OrderTriggerMethod", optional, tag="9", default="Trade")]
    pub stop_loss_trigger_method: ::core::option::Option<i32>,
}
...
pub struct ClosePositionReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaClosePositionReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct TrailingSlChangedEvent {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaTrailingSlChangedEvent")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct AssetListReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaAssetListReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct AssetListRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaAssetListRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SymbolsListReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSymbolsListReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SymbolsListRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSymbolsListRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SymbolByIdReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSymbolByIdReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SymbolByIdRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSymbolByIdRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SymbolsForConversionReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSymbolsForConversionReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SymbolsForConversionRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSymbolsForConversionRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SymbolChangedEvent {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSymbolChangedEvent")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct AssetClassListReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaAssetClassListReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct AssetClassListRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaAssetClassListRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct TraderReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaTraderReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct TraderRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaTraderRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct TraderUpdatedEvent {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaTraderUpdateEvent")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct ReconcileReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaReconcileReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct ReconcileRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaReconcileRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct OrderErrorEvent {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaOrderErrorEvent")]
    pub payload_type: ::core::option::Option<i32>,
    ///Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="5")]
    pub ctid_trader_account_id: i64,
...
pub struct DealListReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaDealListReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct DealListRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaDealListRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct ExpectedMarginReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaExpectedMarginReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct ExpectedMarginRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaExpectedMarginRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct MarginChangedEvent {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaMarginChangedEvent")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct CashFlowHistoryListReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaCashFlowHistoryListReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct CashFlowHistoryListRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaCashFlowHistoryListRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct GetAccountListByAccessTokenReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaGetAccountsByAccessTokenReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// The Access Token issued for providing access to the Trader's Account.
    #[prost(string, required, tag="2")]
    pub access_token: ::prost::alloc::string::String,
...
pub struct GetAccountListByAccessTokenRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaGetAccountsByAccessTokenRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// The Access Token issued for providing access to the Trader's Account.
    #[prost(string, required, tag="2")]
    pub access_token: ::prost::alloc::string::String,
...
pub struct RefreshTokenReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaRefreshTokenReq")]
    pub payload_type: ::core::option::Option<i32>,
...
pub struct RefreshTokenRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaRefreshTokenRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// The Access Token issued for providing access to the Trader's Account.
    #[prost(string, required, tag="2")]
    pub access_token: ::prost::alloc::string::String,
...
pub struct SubscribeSpotsReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSubscribeSpotsReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SubscribeSpotsRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSubscribeSpotsRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct UnsubscribeSpotsReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaUnsubscribeSpotsReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct UnsubscribeSpotsRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaUnsubscribeSpotsRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SpotEvent {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSpotEvent")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SubscribeLiveTrendbarReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSubscribeLiveTrendbarReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SubscribeLiveTrendbarRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSubscribeLiveTrendbarRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct UnsubscribeLiveTrendbarReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaUnsubscribeLiveTrendbarReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct UnsubscribeLiveTrendbarRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaUnsubscribeLiveTrendbarRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct GetTrendbarsReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaGetTrendbarsReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct GetTrendbarsRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaGetTrendbarsRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct GetTickDataReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaGetTickdataReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct GetTickDataRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaGetTickdataRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct GetCtidProfileByTokenReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaGetCtidProfileByTokenReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// The Access Token issued for providing access to the Trader's Account.
    #[prost(string, required, tag="2")]
    pub access_token: ::prost::alloc::string::String,
...
pub struct GetCtidProfileByTokenRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaGetCtidProfileByTokenRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Trader's profile.
    #[prost(message, required, tag="2")]
...
pub struct DepthEvent {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaDepthEvent")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SubscribeDepthQuotesReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSubscribeDepthQuotesReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SubscribeDepthQuotesRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSubscribeDepthQuotesRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct UnsubscribeDepthQuotesReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaUnsubscribeDepthQuotesReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct UnsubscribeDepthQuotesRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaUnsubscribeDepthQuotesRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SymbolCategoryListReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSymbolCategoryReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct SymbolCategoryListRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaSymbolCategoryRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// Unique identifier of the trader's account. Used to match responses to trader's accounts.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct AccountLogoutReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaAccountLogoutReq")]
    pub payload_type: ::core::option::Option<i32>,
    /// The unique identifier of the trader's account in cTrader platform.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct AccountLogoutRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaAccountLogoutRes")]
    pub payload_type: ::core::option::Option<i32>,
    /// The unique identifier of the trader's account in cTrader platform.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct AccountDisconnectEvent {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaAccountDisconnectEvent")]
    pub payload_type: ::core::option::Option<i32>,
    /// The unique identifier of the trader's account in cTrader platform.
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
...
pub struct MarginCallListReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaMarginCallListReq")]
    pub payload_type: ::core::option::Option<i32>,
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
}
...
pub struct MarginCallListRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaMarginCallListRes")]
    pub payload_type: ::core::option::Option<i32>,
...
pub struct MarginCallUpdateReq {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaMarginCallUpdateReq")]
    pub payload_type: ::core::option::Option<i32>,
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
    #[prost(message, required, tag="3")]
...
pub struct MarginCallUpdateRes {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaMarginCallUpdateRes")]
    pub payload_type: ::core::option::Option<i32>,
}
///* Event that is sent when a Margin Call threshold configuration is updated. 
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MarginCallUpdateEvent {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaMarginCallUpdateEvent")]
    pub payload_type: ::core::option::Option<i32>,
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
    #[prost(message, required, tag="3")]
...
pub struct MarginCallTriggerEvent {
    #[prost(enumeration="PayloadType", optional, tag="1", default="OaMarginCallTriggerEvent")]
    pub payload_type: ::core::option::Option<i32>,
    #[prost(int64, required, tag="2")]
    pub ctid_trader_account_id: i64,
    #[prost(message, required, tag="3")]
