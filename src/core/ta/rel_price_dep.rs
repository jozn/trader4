...
use super::*;
// Deprecated: better to be a noramal indicatore without the need to have seprate big and
//  medium > new indicator: RelPrice

// RelativePrice
//  The formula is a rewrite of rel_dc which itself is taken from DCS2

#[derive(Debug, Default, Clone, Serialize, Deserialize)]
pub struct RelPriceResDep {
...
pub struct RelPriceDep {
    dc_medium: DC,
    dc_big: DC,
    ma_height_med: SMA,
    ma_height_big: SMA,
    stoch_med: Stoch,
    past: VecDeque<RelPriceResDep>,
}
...
impl RelPriceDep {
    ...
    pub fn next(&mut self, candle: impl OHLCV) -> RelPriceResDep {
