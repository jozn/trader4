...
impl DCS2 {
    ...
    pub fn next(&mut self, candle: impl OHLCV) -> DCS2Res {
...
mod tests {
    ...
    #[test]
    fn test_new() {
        assert!(DCS2::new(0).is_err());
        assert!(DCS2::new(1).is_ok());
    }

    #[test]
    fn test_next() {
        let mut _s = DCS2::new(3).unwrap();
    }
