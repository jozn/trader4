...
impl MLEng {
    pub fn set_signals_v1(
        ...
        if mva_big.count > 5 && mva_big.ma_mom > 0. && kid > 10 {
            if rdc.perc_med < 0.2 {
    ...
    // Just for showcase pictures, when open sourcing the project
    pub fn set_signals_random_for_showcase(
        &mut self,
        tick: &BTickData,
        sf: &mut MLFrame,
        mbr: &MultiBarRes,
